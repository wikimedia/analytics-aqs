...
aqsUtil.normalizeProject = function(rp, opts) {
    ...
    if (opts.noAllProjects && rp.project.startsWith('all-')) {
 ...
 */
aqsUtil.normalizePageTitle = function(rp, opts) {
    opts = opts || {};
    if (rp['page-title']) {
        rp['page-title'] = rp['page-title'].replace(/ /g, '_');
    }
};
...
aqsUtil.validateYearMonthDay = function(rp, opts) {
    ...
    const validDate = aqsUtil.validateTimestamp(start);
